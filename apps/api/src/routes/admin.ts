 ...
 */
async function getModerationQueue(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
 ...
 */
async function approveVideo(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
 ...
 * Get reports
 */
async function getReports(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
 ...
 */
async function handleReport(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
    ...
    const { action, notes } = request.body as { action: 'dismiss' | 'delete_video'; notes?: string };
 ...
 * Get user analytics
 */
async function getUserAnalytics(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
 ...
 */
async function getPlatformAnalytics(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
