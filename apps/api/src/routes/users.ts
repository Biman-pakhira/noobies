 ...
 */
async function getWatchHistory(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
 ...
 */
async function getLikedVideos(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
 ...
 * Get user playlists
 */
async function getPlaylists(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
 ...
 * Create playlist
 */
async function createPlaylist(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
