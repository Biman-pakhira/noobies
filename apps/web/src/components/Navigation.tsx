          ...
          <form onSubmit={handleSearch} className="hidden sm:flex flex-1 max-w-xs">
            <div className="relative w-full">
              <input
                ...
                className="w-full bg-gray-800 text-white px-4 py-2 rounded-lg border border-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500 text-sm"
              />
              <button
                type="submit"
          ...
          <div className="flex items-center gap-4">
            {isAuthenticated && user ? (
              ...
              <div className="flex items-center gap-2">
                <Link
                  href="/login"
                  className="px-4 py-2 text-white hover:text-red-500 transition text-sm"
                >
                  Login
                </Link>
                <Link
