        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap items-center gap-4 mb-6 pb-6 border-b border-gray-800">
            ...
            <div className="flex gap-6 ml-auto">
              <button
                onClick={handleLike}
                className="flex items-center gap-2 px-4 py-2 hover:bg-gray-900 rounded transition"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    ...
                    strokeWidth={2}
                    d="M14 10h4.764a2 2 0 011.789 2.894l-3.646 7.23a2 2 0 01-1.789 1.106H5a2 2 0 01-2-2V9a2 2 0 012-2h6.236a1 1 0 00.894-.553l1.342-2.694a1 1 0 00-.894-1.447H5a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-7"
                  />
                </svg>
